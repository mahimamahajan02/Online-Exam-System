...
Class Signup_teacher0 extends CI_Controller {
...
$status=1;
$this->load->model('Signup_teacher_Model0');
$this->Signup_teacher_Model0->insert($fname,$lname,$emailid,$mnumber,$password,$status);
} else {
$this->load->view('teacher/signup_teacher0');
}
