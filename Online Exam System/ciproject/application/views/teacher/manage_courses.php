...
<a href="<?php echo site_url('course/add0'); ?>" class="pull-right btn btn-success btn-xs" name="button"><i class="fas fa-plus"></i> Add New</a>
...
?>
                    ...
                    <td>
                        <?php echo  anchor("teacher/Manage_Courses/deletecourse/{$row->id}",' ','class="fa fa-trash"')?>
                        <?php echo  anchor("teacher/Manage_Courses/updateprofilecourse/{$row->id}",' ','class="fa fa-edit"')?>
